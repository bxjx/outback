  ...
  describe("Client collection", function() {
    return describe("When synchronising caseload with bridge with a valid token", function() {
      beforeEach(function() {
        ...
        return this.server.respondWith("GET", "/api/v1/clients/caseload?token=0d2acb7d-d4f6-4dbb-bf6e-6ebac7fa5a21", this.validResponse(this.fixture));
      });
      afterEach(function() {
      ...
      it("should make the correct request", function() {
        ...
        return expect(this.server.requests[0].url).toEqual("/api/v1/clients/caseload?token=0d2acb7d-d4f6-4dbb-bf6e-6ebac7fa5a21");
      });
      return it("should create client models for each client on the caseload", function() {
